...
public class CreateFreelancerProfile3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_freelancer_profile3);

        sp=getSharedPreferences("proj", Context.MODE_PRIVATE);

        completeBtn=findViewById(R.id.fpCompleteBtn);
