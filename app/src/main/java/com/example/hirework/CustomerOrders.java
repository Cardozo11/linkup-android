...
public class CustomerOrders extends AppCompatActivity {
    ...
    private static final String CUSTOMER_ACTIVE_ORDERS_URL="https://hirework.tech/pActiveOrders.php?cUsername=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler=findViewById(R.id.pendingRecycler);
        ...
        HorizontalLayout2 = new LinearLayoutManager(CustomerOrders.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter=new PendingOrdersAdapter(getApplicationContext(), orderList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CustomerOrders.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
